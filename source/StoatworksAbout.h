/*
 * Stoatworks Labs - About window data for Flenser.
 *
...
{
    inline constexpr auto name = "Flenser";
    inline constexpr auto slug = "flenser";
    inline constexpr auto hook = "A liquid light show, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/flenser/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/flenser/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/flenser";
