...
**[v0.1.4](https://github.com/stoatworks-labs/flenser/releases/tag/v0.1.4)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`flenser-0.1.4-macos-universal.dmg`](https://github.com/stoatworks-labs/flenser/releases/download/v0.1.4/flenser-0.1.4-macos-universal.dmg) | 459 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`flenser-macos-universal.zip`](https://github.com/stoatworks-labs/flenser/releases/latest/download/flenser-macos-universal.zip) | 406 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`flenser-0.1.4-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/flenser/releases/download/v0.1.4/flenser-0.1.4-windows-x86_64-setup.exe) | 234 KB |
