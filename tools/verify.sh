...
# Mirrors OilShaderSource()/SimmerShaderSource()/FieldProbeShaderSource().
ASSEMBLED = {
	"OilShader":        [ "kOilPreamble", "kOilLibrary", "kOilMain" ],
	"SimmerShader":     [ "kSimmerPreamble", "kOilLibrary", "kSimmerMain" ],
	"FieldProbeShader": [ "kProbePreamble", "kOilLibrary", "kProbeMain" ],
}
